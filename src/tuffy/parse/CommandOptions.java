...
public class CommandOptions {
    ...
    @Option(name="-e", aliases="-evidence", required=true, usage="REQUIRED. Input evidence file.. Specifies Domain")
    public String fevid;
    ...
    @Option(name="-k", required=true, usage="The number of Iterations")
    ...
    @Option(name="-runBox", usage="Runs Box propagation instead of usual BP")
